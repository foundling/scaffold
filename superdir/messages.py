cli_messages = {
    ...
    "config": ("The path to your config file. The config file is read before " 
              "superdir'ing your schema into existence."),

    "outdir": ("Directory name to contain your superdir'd files. If none is "
